/**
 * <p>
 * Classname:  jdk8examples.streams.mapsandflatmas.Java8MapExample
 * </p>
 *
...
public class Java8MapExample {
    ...
    public static void main(String[] args) {
        ...
        vowels.stream().map( 
          vowel -> vowel.toLowerCase()).forEach(value -> System.out.println(value));
        ...
        nestedList.stream().map( 
          list -> {return list.stream().map(
