...
public class VisualSwingworkerDemo
    implements Runnable {
  ...
  class MeaningOfLifeFinder
      extends VisualSwingWorker<String, Object> {
  ...
  public void run() {
    ...
    findTheAnswer.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        new MeaningOfLifeFinder().execute(frame,
            "Finding the Meaning of life ...", "I am working on it !",
