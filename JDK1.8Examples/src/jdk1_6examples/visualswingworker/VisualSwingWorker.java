package jdk1_6examples.visualswingworker;
...
public abstract class VisualSwingWorker<T, V>
  ...
  private class WaitingDialog
    ...
    private WaitingDialog(Component father, String title, String message,
      ...
      if (allowCancel) {
        JButton cancelButton = new JButton(UIManager.getString(
...
//        }
   ...
   * @param message
   */
  public void execute(final Component father, final String title,
      final String message, final boolean allowCancel) {

//    SwingUtilities.invokeLater(new Runnable() {
//      public void run() {
//        final WaitingDialog dialog = new WaitingDialog(father, title, message,
//            allowCancel);
