...
public class BarChartMain {
  ...
  private static class NumberTableModel
  ...
  public static void main(String[] args) {
    ...
    final JSpinner spinner = new JSpinner(new SpinnerNumberModel(2000, 0,
        Integer.MAX_VALUE, 100));
    JFrame frame = new JFrame("Bar Chart");
    final JTable table = new JTable();
    final TableSorter sorter = new TableSorter(new NumberTableModel(
        allowNegCheckBox.isSelected(), ( (Number) spinner.getValue()).intValue()),
    ...
    table.setToolTipText(
        ...
        "Use Shift + Control and the mouse wheel to zoom over a selection.<BR>" + "Use Control + double click on the mouse wheel to restore default row height.</body></html>");
