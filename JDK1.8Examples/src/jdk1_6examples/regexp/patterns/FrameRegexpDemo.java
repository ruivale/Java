...
public class FrameRegexpDemo extends JFrame {
  JPanel contentPane;
  ...
  private void jbInit() throws Exception  {
    ...
    btnMatch.addActionListener(new FrameRegexpDemo_btnMatch_actionAdapter(this));
    btnSplit.setText("Split");
    btnSplit.addActionListener(new FrameRegexpDemo_btnSplit_actionAdapter(this));
    btnObjects.setAlignmentY((float) 0.5);
    btnObjects.setActionCommand("Create Objects");
    btnObjects.setText("Create Objects");
    btnObjects.addActionListener(new FrameRegexpDemo_btnObjects_actionAdapter(this));
    btnNextMatch.setText("Next Match");
    btnNextMatch.addActionListener(new FrameRegexpDemo_btnNextMatch_actionAdapter(this));
    btnObjReplace.setSelected(false);
    btnObjReplace.setText("Obj Replace");
    btnObjReplace.addActionListener(new FrameRegexpDemo_btnObjReplace_actionAdapter(this));
    btnObjSplit.setText("Obj Split");
    btnObjSplit.addActionListener(new FrameRegexpDemo_btnObjSplit_actionAdapter(this));
    btnReplace.setText("Replace");
    btnReplace.addActionListener(new FrameRegexpDemo_btnReplace_actionAdapter(this));
    ...
    btnAdvancedReplace.addActionListener(new FrameRegexpDemo_btnAdvancedReplace_actionAdapter(this));
...
class FrameRegexpDemo_btnMatch_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnMatch_actionAdapter(FrameRegexpDemo adaptee) {
...
class FrameRegexpDemo_btnReplace_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnReplace_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class FrameRegexpDemo_btnSplit_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnSplit_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class FrameRegexpDemo_btnObjects_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnObjects_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class FrameRegexpDemo_btnNextMatch_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnNextMatch_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class FrameRegexpDemo_btnObjReplace_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnObjReplace_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class FrameRegexpDemo_btnAdvancedReplace_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnAdvancedReplace_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class FrameRegexpDemo_btnObjSplit_actionAdapter implements java.awt.event.ActionListener {
  FrameRegexpDemo adaptee;

  FrameRegexpDemo_btnObjSplit_actionAdapter(FrameRegexpDemo adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
