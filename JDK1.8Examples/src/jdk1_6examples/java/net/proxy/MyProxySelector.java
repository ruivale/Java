package jdk1_6examples.java.net.proxy;
...
public class MyProxySelector
  ...
  MyProxySelector(ProxySelector def) {
    ...
    InnerProxy i = new InnerProxy(new InetSocketAddress("172.18.2.6", 3000));
    proxies.put(i.address(), i);
    i = new InnerProxy(new InetSocketAddress("172.18.2.6", 3001));
    proxies.put(i.address(), i);
    i = new InnerProxy(new InetSocketAddress("172.18.2.6", 3002));
    proxies.put(i.address(), i);
  }
