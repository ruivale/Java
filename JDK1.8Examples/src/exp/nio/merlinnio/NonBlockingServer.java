...
System.out.println("----------------------------------------------------");
    ...
    while (acceptKey.selector().select() > 0) {
      ...
      while (it.hasNext()) {
        ...
        if (key.isAcceptable()) {
          System.out.println("Key is Acceptable: "+key.toString()+".");
        ...
        if (key.isReadable()) {
          System.out.println("Key is readable: "+key.toString()+".");
        ...
        if (key.isWritable()) {
          System.out.println("Key is writable: "+key.toString()+".");
          String ret = readMessage(key);
  ...
  public void writeMessage(SocketChannel socket, String ret) {
    System.out.println("writeMessage inside the loop");
