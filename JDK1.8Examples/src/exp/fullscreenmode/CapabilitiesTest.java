...
class GCWrapper {
  ...
  /**
   * Creates a new GCWrapper object.
   *
...
public class CapabilitiesTest extends JFrame implements ItemListener {
  ...
  /**
   * Creates a new CapabilitiesTest object.
   *
  ...
  public CapabilitiesTest (GraphicsDevice dev) {
    ...
    for(int i = 0; i < gcs.length; i++) {
      gcSelection.addItem(new GCWrapper(
          gcs[i],
          i));
    }
  ...
  private void initComponents (Container c) {
    ...
    c.add(
      gcPanel,
      BorderLayout.NORTH);
    gcSelection.setPreferredSize(new Dimension(
        400,
        30));
    ...
    // Image Capabilities
    JPanel imageCapsPanel = new JPanel(new GridLayout(
          2,
          1));
    capsPanel.add(
      imageCapsPanel,
      BorderLayout.NORTH);
    imageCapsPanel.setBorder(
      BorderFactory.createTitledBorder("Image Capabilities"));
    ...
    capsPanel.add(
      bufferCapsPanel,
      BorderLayout.CENTER);
    bufferCapsPanel.setBorder(
      BorderFactory.createTitledBorder("Buffer Capabilities"));

    // Buffer Access
    JPanel bufferAccessCapsPanel = new JPanel(new GridLayout(
          3,
          1));
    bufferAccessCapsPanel.setPreferredSize(new Dimension(
        300,
        88));
    bufferCapsPanel.add(
      bufferAccessCapsPanel,
    ...
    indentPanel.setPreferredSize(new Dimension(
        30,
        30));
    ...
    JPanel buffersPanel = new JPanel(new GridLayout(
          1,
          2));
    bufferCapsPanel.add(
      buffersPanel,
    ...
    // Front Buffer
    JPanel fbPanel = new JPanel(new GridLayout(
          2,
          1));
    ...
    // Back Buffer
    JPanel bbPanel = new JPanel(new GridLayout(
          2,
          1));
    bbPanel.setPreferredSize(new Dimension(
        250,
        80));
    bbPanel.setBorder(
      BorderFactory.createTitledBorder("Back and Intermediate Buffers"));
