...
public class InnerFrame
  ...
  private static ImageIcon ICONIZE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "iconize.gif");
  private static ImageIcon RESTORE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "restore.gif");
  private static ImageIcon CLOSE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "close.gif");
  private static ImageIcon MAXIMIZE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "maximize.gif");
  private static ImageIcon MINIMIZE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "minimize.gif");
  private static ImageIcon PRESS_CLOSE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "pressclose.gif");
  private static ImageIcon PRESS_RESTORE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "pressrestore.gif");
  private static ImageIcon PRESS_ICONIZE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "pressiconize.gif");
  private static ImageIcon PRESS_MAXIMIZE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "pressmaximize.gif");
  private static ImageIcon PRESS_MINIMIZE_BUTTON_ICON = new ImageIcon(IMAGE_DIR +
      "pressminimize.gif");
  private static ImageIcon DEFAULT_FRAME_ICON = new ImageIcon(IMAGE_DIR +
      "default.gif");
  ...
  private static Color DEFAULT_SELECTED_TITLE_BAR_BG_COLOR = new Color(91, 182,
      249);
  ...
  public InnerFrame(String title, ImageIcon frameIcon, boolean resizeable,
                    boolean iconizeable, boolean maximizeable,
                    boolean closeable) {
      ...
      switch (m_mode) {
        ...
        case NORTHEAST:
          if (h - (ey - m_dragY) >= MIN_HEIGHT
            ...
            m_resizeComponent.setBounds(x,
                                        y + (ey - m_dragY),
                                        w + (ex - (getWidth() - CORNER)),
                                        h - (ey - m_dragY));
          } else if (h - (ey - m_dragY) >= MIN_HEIGHT
                     && ! (w + (ex - (getWidth() - CORNER)) >= MIN_WIDTH)) {
            m_resizeComponent.setBounds(x,
                                        y + (ey - m_dragY), MIN_WIDTH,
                                        h - (ey - m_dragY));
          } else if (! (h - (ey - m_dragY) >= MIN_HEIGHT)
                     && w + (ex - (getWidth() - CORNER)) >= MIN_WIDTH) {
            m_resizeComponent.setBounds(x,
