...
public class ReloadablePropertyResourceBundle extends PropertyResourceBundle {
  ...
  private static ResourceBundle searchBundle(String baseName,
    StringBuffer localeName, final ClassLoader loader, boolean includeBase) {
...
searchLoop:
    while (true) {
      ...
      synchronized (cacheList) {
        ...
        if (lookup != null) {
          ...
          if (lookup instanceof ReloadablePropertyResourceBundle) {
            ...
            if (((url != null) &&
                (((ReloadablePropertyResourceBundle) lookup).lastModified == lastDate)) ||
                (lastDate == 0)) {
              localeName.setLength(0);
      ...
      if (stream != null) {
        ...
        try {
          lookup = (Object) new ReloadablePropertyResourceBundle(stream,
              resName, lastDate);
