...
public class NimbusBrowser {
  ...
  private static Set<String> NIMBUS_SECONDARY_COLORS = new HashSet<String>(Arrays.asList(
      ...
      "controlText", "controlHighlight", "controlLHighlight", "controlShadow", "controlDkShadow",
      "textHighlight",
  ...
  private static String[] NIMBUS_COMPONENTS = new String[]{
    ...
    "DesktopPane", "Label", "List", "MenuBar", "MenuItem", "RadioButtonMenuItem", "CheckBoxMenuItem",
    "Menu",
    ...
    "\"Table.editor\"", "\"Tree.cellEditor\"", "TextField", "FormattedTextField", "PasswordField",
    "TextArea",
...
componentloop:
          for (String componentName : NIMBUS_COMPONENTS) {
            if (key.startsWith(componentName + ".") || key.startsWith(componentName + ":") || key.
  ...
  static void printTable(PrintWriter html,
  ...
  static void printRow(PrintWriter html,
                       String key,
                       Object value) {
    ...
    if(value != null){
      ...
      System.out.println("Cannot print row cause the value is NULL.");
    }
  }

  static void printColor(PrintWriter html,
                         Color color) {
  ...
  static void printPainter(PrintWriter html,
                           Painter painter) {
  ...
  static void printFont(PrintWriter html,
                        Font font) {
    String style = "";
  ...
  static void printInsets(PrintWriter html,
                          Insets insets) {
  ...
  static void printBorder(PrintWriter html,
                          Border border) {
  ...
  static void printDimension(PrintWriter html,
                             Dimension dim) {
  ...
  static void printIcon(PrintWriter html,
                        Icon icon) {
