...
public class VenetianPane
    extends TransitionTabbedPane {
  ...
  public VenetianPane(final int intAnimationLength) {
    super(intAnimationLength);
    this.setAnimationLength(intAnimationLength);
  }

  public VenetianPane(
      final int intAnimationLength,
      final int intSleepingMillisBetweenCicles) {
    super(intAnimationLength, intSleepingMillisBetweenCicles);
    this.setAnimationLength(intAnimationLength);
