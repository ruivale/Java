/**
 * <p>
 * Classname: jdk8examples.i18n.arabic.InternationalizedMortgageCalculator
 * </p>
 *
 * <p>
 ...
 * </p>
 */
package jdk8examples.i18n.comps;
...
public class InternationalizedMortgageCalculator extends JPanel implements PropertyChangeListener {
  ...
  public InternationalizedMortgageCalculator(Locale currentLocale) {
    ...
    // Create the labels.
    labels = ResourceBundle.getBundle("jdk8examples.i18n.comps.resources.Resources", currentLocale);
    ...
    final JButton jb = new JButton(labels.getString("AMOUNT_STRING"));
    jb.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        //final JFrame f = new JFrame(labels.getString("AMOUNT_STRING"));
        final JDialog f = new JDialog(frame, labels.getString("AMOUNT_STRING"));
        //f.applyComponentOrientation(ComponentOrientation.getOrientation(currentLocale));
        f.setLayout(new GridLayout());
        f.add(new JLabel(labels.getString("AMOUNT_STRING")));
        f.add(new JTextField(labels.getString("AMOUNT_STRING")));
        f.add(new JButton(labels.getString("AMOUNT_STRING")));
        f.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        f.setBounds(100,100,550,65);
        f.setVisible(true);
      }
    });
