package jdk18examples.streaminparallel;
...
public final class StreamBenchmarks {
  ...
  public static void main(String[] args) {                               // (17)
    ...
    xqtFunctions(StreamBenchmarks::seqSumRangeClosed, StreamBenchmarks::paraSumRangeClosed);

    
    System.out.println("Streams created with the iterate() method:");    // (19)
    System.out.println(" Size Sequential Parallel");
    
    xqtFunctions(StreamBenchmarks::seqSumIterate, StreamBenchmarks::paraSumIterate);
