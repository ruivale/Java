 ...
 *    JDK 17 adds the (preview) ability to include the previously illegal case null clause in a 
 *    switch. Historically, you had to check for null cases outside the switch, as shown by old() 
 *    in the code below.
 *
 *    In checkNull() you see that null is now a legitimate case for a switch using both arrow and 
 *    colon syntax.
 * 
