 ...
 * <p>
 * JExternalFrame tries to combine the functionality and pluggable L & F of
 * a JInternalFrame with the top-level status of a Window or Frame.  You use
 * it just like a JFrame (except I wouldn't recommend doing any fancy stuff
 * with setContentPane, setGlassPane, or setLayeredPane.)  Call
...
public class JExternalFrame
    extends JWindow implements WindowConstants {
  ...
  public JExternalFrame(String title,
    ...
    }); //Ends addInternalFrameListenersaassa
  ...
  public void setBounds(int x, int y, int width, int height) {
    ...
    if (!iconified && realFrame != null) {
      ...
      System.out.println("a realframe ´e null!");
    }
  ...
  public static void main(String[] argv) {
    ...
    JExternalFrame jef = new JExternalFrame("Simple Test 1", true, true, true);
  ...
  //******************************** Ends Methods ****************************
   ...
   //******************************** Inner Classes ***************************
    protected class MiniDesktopManager
        extends DefaultDesktopManager implements SwingConstants {
