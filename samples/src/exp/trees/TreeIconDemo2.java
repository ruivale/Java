...
public class TreeIconDemo2 extends JFrame {
  ...
  public TreeIconDemo2() {
    ...
    //treeView.setPreferredSize(new Dimension(100, 100));         splitPane.setPreferredSize(new Dimension(500, 300));         //Add the split pane to this frame.
  ...
  private void createNodes(DefaultMutableTreeNode top) {
    ...
    category.add(book);         //FAQ
    book = new DefaultMutableTreeNode(new BookInfo(
                                        "The Java FAQ", "faq.html"));
    category.add(book);         //Chan/Lee
    book = new DefaultMutableTreeNode(new BookInfo
                                      ("The Java Class Libraries: An Annotated Reference",
                                       "chanlee.html"));
    category.add(book);         //Threads
    book = new DefaultMutableTreeNode(new BookInfo
  ...
  public static void main(String[] args) {
    JFrame frame = new TreeIconDemo2(); frame.addWindowListener(new WindowAdapter() {
