...
package jdk1_6examples.java.awt.component.capture2image;
...
class ComponentImageCapture {
 ...
 public static BufferedImage getScreenShot(final Component component) {
           ...
           public void actionPerformed(ActionEvent ae) {
             ...
             try {
               ...
               ImageIO.write(
                 img,
                 "png",
                 new File("c:/temp/screenshot.png"));
             } catch(Exception e) {
               e.printStackTrace();
             }
           }
